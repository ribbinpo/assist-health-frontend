        ...
        <div className='bg-black'>
            <div className='justify-items-center'>
                <div ><img src={ Dashboard } className="w-full"/></div>
                    ...
                    <div className='w-full flex justify-center'><img src={Cardio} alt="" /></div>
                    <div className='w-full flex justify-center'><img src={Strength} alt="" /></div>
                    <div className='w-full flex justify-center'><img src={Flexlity} alt="" /></div>
                    <div className='w-full flex justify-center'><img src={Dashboardinfo} alt="" /></div>
                </div>
