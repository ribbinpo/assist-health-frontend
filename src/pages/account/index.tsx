    ...
    <form onSubmit={onSubmit} className="flex justify-center items-center min-h-screen pt-8 pb-8 bg-black">
        <div className="flex flex-col gap-y-5 py-20 rounded-md px-8" style={{ backgroundColor: '#EAE9E9' }}>
          <div className='flex iteams-center'>
            ...
            <div><LabelForm text="Username"/><TextField placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)}/></div>
            <div><LabelForm text="Email"/><TextField placeholder="Email" value={email}  onChange={(e) => setEmail(e.target.value)} /></div>
            ...
            <div><LabelForm text="Birthday"/><input type="date"className="form-input rounded-md border-none p-3  w-full " value={birthday} onChange={(e) => setBirthday(e.target.value)}/></div>
            <div><LabelForm text="ID-Card/Passport"/><TextField placeholder="ID-Card/Passport" value={idcard} onChange={(e) => setIdcard(e.target.value)} /></div>
