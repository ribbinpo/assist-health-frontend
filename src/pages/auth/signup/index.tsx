    ...
    <div className="flex justify-center items-center min-h-screen pt-8 pb-8">
        <div className="flex flex-col gap-y-5 px-36 py-20 rounded-md" style={{ backgroundColor: '#EAE9E9' }}>
          <div className='flex iteams-center'>
            ...
            <div className='grid gap-4 grid-cols-2 '>
                <select id="blood" name="blood"   className='form-input rounded-md border-none p-3 text-[#595757]'>
                ...
                <div>
                <select id="country" name="country" className='form-input rounded-md border-none p-3 text-[#595757]'>
