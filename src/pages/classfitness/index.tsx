      ...
      <div className="flex px-8">
        <div className="flex justify-between">
          <button
            ...
            className={`${
              currentClassType === CLASSTYPE.ALL ? 'border-[#CC1B32]' : 'border-white'
        ...
        <div className="flex justify-between">
          <button
            ...
            className={`${
              currentClassType === CLASSTYPE.CARDIO ? 'border-[#D0E495]' : 'border-white'
        ...
        <div className="flex justify-between">
          <button
            ...
            className={`${
              currentClassType === CLASSTYPE.STRENGTH ? 'border-[#F17474]' : 'border-white'
        ...
        <div className="flex justify-between">
          <button
            ...
            className={`${
              currentClassType === CLASSTYPE.FLEXLITY ? 'border-[#74B5F1]' : 'border-white'
